...
function Footer() {
  return (
    <>
      <footer className="section footer footer-center bg-accent mt-20 p-10 border-t border-[#5e5e5e6f]">
        <aside>
          <p className="font-bold">Ali Shakeel</p>
